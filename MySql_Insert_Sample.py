...
sql = 'insert into customers (customer_id,first_name,last_name,birth_date,phone,address,city,state,' \
      'points) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)'
values = [('23', 'Rajesh', 'Manasamudhram', '1981-08-29', '7829570025', 'ND Passion', 'Bangalore', 'KA', '9876'),
          ('24', 'Rajesh', 'Manasamudhram', '1981-08-29', '7829570025', 'ND Passion', 'Bangalore', 'KA', '9876')]
